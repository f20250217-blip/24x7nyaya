...
export function Navbar() {
  ...
  return (
    <nav className="on-dark sticky top-0 z-50 w-full border-b border-[#A6812A]/45 bg-gradient-to-r from-[#1A243F]/93 via-[#141C30]/90 to-[#1A243F]/93 backdrop-blur-md shadow-[0_1px_0_rgba(166,129,42,0.2),0_8px_24px_-12px_rgba(26,36,63,0.35)]">
